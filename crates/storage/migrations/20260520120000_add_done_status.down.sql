...
INSERT INTO ideas_new (id, title, body, problem, author_user_id, status, created_at, updated_at)
SELECT id, title, body, problem, author_user_id, CASE WHEN status = 'done' THEN 'closed' ELSE status END, created_at, updated_at
FROM ideas;
